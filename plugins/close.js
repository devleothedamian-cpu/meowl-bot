    ...
    async execute(sock, msg, options) {
        try {
            ...
            if (!isGroupAdmin &&!hasBotRank) {
                return sock.sendMessage(from, {text: `🔒 Grupo cerrado Solo admins del grupo pueden usar este comando`}, {quoted: msg});
            }

            if (!botIsAdmin) {
                return sock.sendMessage(from, {text: `✳️ *${config.name || 'Bot'}* debe ser administrador del grupo`}, {quoted: msg});
            }
