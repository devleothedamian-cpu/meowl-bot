        ...
        try {
            ...
            if (!args ||!args.length) {
                return await sock.sendMessage(from, {
                    text: `✳️ *Debes proporcionar el nombre de la aplicación*\n\n> Ejemplo: ${config.prefix}apk facebook`,
                    contextInfo: {
            ...
            if (!apkInfo) {
                return await sock.sendMessage(from, {
                    text: `✳️ No se pudo obtener la información de la aplicación`,
                    contextInfo: {
                        mentionedJid: [senderJid],
                        forwardingScore: 9999,
                        isForwarded: true,
            ...
            if (sizeBytes > 524288000) {
                return await sock.sendMessage(from, {
                    text: `✳️ El archivo es demasiado grande (${size}).\n> Descárgalo directamente desde aquí:\n${downloadUrl}`,
                    contextInfo: {
                        mentionedJid: [senderJid],
                        forwardingScore: 9999999,
                        isForwarded: true,
