        ...
        try {
            ...
            if (usersDB && senderNumber && !usersDB[senderNumber]) {
                await sock.sendMessage(from, { 
                    text: `✳️ Para usar mis comandos tienes que estar registrado.\n> Uso: ${config.prefix}reg Misa.16`,
                    contextInfo: {
            ...
            if (!text) {
                await sock.sendMessage(from, {
                    text: '✳️ Por favor, ingresa un texto para crear el Sticker animado.',
                    contextInfo: {
            ...
            if (error.message.includes('FFmpeg')) {
                errorMsg += '\n\n✳️ Para stickers animados necesito FFmpeg instalado.';
            }
