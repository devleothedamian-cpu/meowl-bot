...
const save = (d) => {
    ...
    const palabras = ['GALAXIA', 'BOT', 'MARDEL', 'ECONOMY', 'DINERL', 'FUTBOL', 'BOT', 'PERU','WORK', 'ARGENTINA','MEXICO', 'BOLIVIA', 'ESPAÑA','CUBA', 'PANAMA', 'MANDARINA','PERA', 'MANZANA', 'CABO VERDE','WHATSAPP'];
const MAX_VIDAS = 6;
